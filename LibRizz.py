...
def main():
    ...
    driver1.get(url)
    gotoday(driver1)
    ReserveEngine(driver1, datetime.strptime("10:00am", "%I:%M%p"), datetime.strptime("2:00pm", "%I:%M%p"), NID1, Password1, SID1, Name1)
    ReserveEngine(driver1, datetime.strptime("2:00pm", "%I:%M%p"), datetime.strptime("6:00pm", "%I:%M%p"), NID2, Password2, SID2, Name2)
    Exit(driver1)
